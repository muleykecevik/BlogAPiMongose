...
// const crypto = require('node:crypto')  dahili module install yapmaya gerek yok node: denmesinden anlariz 
...
const UserSchema = new mongoose.Schema({
    ...
    password: {
        ...
        trim: true,
        required: true,
        // set: (password) => { return password + '123' }, gelen vveri ne olursa olsun yanina 123 ekle
